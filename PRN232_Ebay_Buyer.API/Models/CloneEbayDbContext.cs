...
namespace PRN232_Ebay_Buyer.API.Models;
...
public partial class CloneEbayDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__User__3213E83F0C06FE3D");
            entity.ToTable("User");
            entity.HasIndex(e => e.Email, "UQ__User__AB6E6164ADDEAD7A").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Address__3213E83F8D318B04");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Bid__3213E83F0BCF335E");
            entity.ToTable("Bid");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Amount).HasColumnType("decimal(10, 2)").HasColumnName("amount");
            entity.Property(e => e.BidTime).HasColumnType("datetime").HasColumnName("bidTime");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Category__3213E83F836107BD");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Coupon__3213E83FD18ADFA4");
            entity.ToTable("Coupon");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Code).HasMaxLength(50).HasColumnName("code");
            entity.Property(e => e.DiscountPercent).HasColumnType("decimal(5, 2)").HasColumnName("discountPercent");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Dispute__3213E83F6BA02FE3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Feedback__3213E83F115892F3");
            entity.ToTable("Feedback");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.AverageRating).HasColumnType("decimal(3, 2)").HasColumnName("averageRating");
            entity.Property(e => e.PositiveRate).HasColumnType("decimal(5, 2)").HasColumnName("positiveRate");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Inventor__3213E83F8498D7BE");
            entity.ToTable("Inventory");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.LastUpdated).HasColumnType("datetime").HasColumnName("lastUpdated");
            entity.Property(e => e.ProductId).HasColumnName("productId");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Message__3213E83FCA45E61C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrderIte__3213E83FEF62FAE6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__OrderTab__3213E83F831CCDDB");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Payment__3213E83F6DDD40D6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Product__3213E83FDE7A946D");
            entity.ToTable("Product");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.AuctionEndTime).HasColumnType("datetime").HasColumnName("auctionEndTime");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ReturnRe__3213E83F90EC11A3");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Review__3213E83F02A3215E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Shipping__3213E83FD3E336B6");
            entity.ToTable("ShippingInfo");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.Carrier).HasMaxLength(100).HasColumnName("carrier");
            entity.Property(e => e.EstimatedArrival).HasColumnType("datetime").HasColumnName("estimatedArrival");
            entity.Property(e => e.OrderId).HasColumnName("orderId");
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.ShippingInfos)
                .HasForeignKey(d => d.OrderId)
                .HasConstraintName("FK__ShippingI__order__4E88ABD2");
        });

        modelBuilder.Entity<Store>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Store__3213E83FE640BE81");
            entity.ToTable("Store");
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.BannerImageUrl).HasColumnName("bannerImageURL");
            entity.Property(e => e.Description).HasColumnName("description");
            entity.Property(e => e.SellerId).HasColumnName("sellerId");
            entity.Property(e => e.StoreName).HasMaxLength(100).HasColumnName("storeName");
